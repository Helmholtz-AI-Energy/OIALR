...
def obj_train():
    ...
    base_config_path = Path("/hkfs/work/workspace/scratch/qv2382-madonna-ddp/madonna/configs/")
    ...
    def train(config: DictConfig):
        ...
        overrides = OmegaConf.load(
            f"/hkfs/work/workspace/scratch/qv2382-madonna-ddp/madonna/configs/tmp/newest_config_{rank}.yaml",
        )
