...
if __name__ == "__main__":
    ...
    log_path = Path("/hkfs/work/workspace/scratch/qv2382-madonna2/madonna/logs/propulate/cifar10-1/")
    ...
    islands = propulate.Islands(
        ...
        checkpoint_path=Path("/hkfs/work/workspace/scratch/qv2382-madonna2/hpsearch/cifar10-1/"),
    )
